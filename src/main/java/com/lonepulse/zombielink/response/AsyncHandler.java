...
public abstract class AsyncHandler<RESPONSE> {
	 ...
	 * 
	 * <p>This callback will be invoked if request execution failed with an {@link Exception}. It signifies 
	 * a failure to execute the request or handle the response; unlike {@link #onFailure(HttpResponse)} which 
	 * indicates a non-successful <a href="http://en.wikipedia.org/wiki/List_of_HTTP_status_codes">
