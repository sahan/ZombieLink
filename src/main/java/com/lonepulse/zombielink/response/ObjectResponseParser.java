...
class ObjectResponseParser extends AbstractResponseParser<Object> {
	 ...
	 * 
	 * @see AbstractResponseParser#parse(HttpResponse, com.lonepulse.zombielink.processor.ProxyInvocationConfiguration)
	 */
	@Override
	...
	/**
	 * @see com.lonepulse.zombielink.processor.AbstractResponseParser#getType()
	 */
	@Override
