...
public class EndpointValidationTest {
	...
	public void setUp() throws Exception {
		...
		missingEndpointAnnotationExceptionClass = (Class<Throwable>) 
			Class.forName("com.lonepulse.zombielink.processor.validator.MissingEndpointAnnotationException");
		
		missingEndpointHostExceptionClass = (Class<Throwable>) 
			Class.forName("com.lonepulse.zombielink.processor.validator.MissingEndpointHostException");
	}
